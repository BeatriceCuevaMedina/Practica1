...
<body class="nuevoEstilo3">
    <form id="form1" runat="server" class="nuevoEstilo1">
        <div class="nuevoEstilo2" style="border-style: double; border-width: 5px; margin-right: 0px; background-image: url('')">
            ...
            <br />
            <br />
            <asp:RadioButtonList ID="Posición" runat="server" AutoPostBack="True" Font-Names="Arial Rounded MT Bold" RepeatLayout="Flow" style="text-align: left" Width="323px">
            ...
            <br />
            <br />
            <asp:Button ID="Grabar" runat="server" Font-Names="Arial Rounded MT Bold" Text="Grabar" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Limpiar" runat="server" Font-Names="Arial Rounded MT Bold" Text="Limpiar" />
            <br />
            <br />
